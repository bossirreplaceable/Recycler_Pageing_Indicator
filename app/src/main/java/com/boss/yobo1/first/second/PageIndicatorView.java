package com.boss.yobo1.first.second;
...
public class PageIndicatorView extends LinearLayout {
    ...
    public void setSelectedPage(int selected) {
        if (currentIndicator!=selected){
            indicatorViews.get(currentIndicator).setBackgroundResource(android.R.drawable.presence_invisible);
            indicatorViews.get(selected).setBackgroundResource(android.R.drawable.presence_online);
            currentIndicator=selected;
        }else {
            indicatorViews.get(selected).setBackgroundResource(android.R.drawable.presence_online);
        }
    }
